          ...
          <div className="flex flex-col md:flex-row gap-12 items-center">
            ...
            <div className="flex-1 order-1 md:order-2">
              <div className="relative">
                ...
                <div className="aspect-square rounded-[3rem] border-2 border-slate-900 shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] overflow-hidden relative flex items-center justify-center">
                  <img
                    src={FounderPhoto}
                    alt="Becc - Founder"
